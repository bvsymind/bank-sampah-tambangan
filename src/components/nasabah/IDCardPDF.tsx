...
//           <h1 className="text-6xl font-bold tracking-wider">KARTU TANDA ANGGOTA</h1>
//           <p className="text-4xl mt-2 opacity-90">Bank Sampah Sido Makmur</p>
//         </div>

//         <div className="flex-grow flex items-center gap-7">
...
export function IDCardPDF({ nasabah }: IDCardPDFProps) {
  ...
  return (
    // Container ini disembunyikan di luar layar
    <div className="fixed -top-[9999px] -left-[9999px] font-sans">
      {/* SISI DEPAN KARTU */}
      <div
        id="id-card-front"
        style={{ width: '1016px', height: '638px' }}
        className="bg-gradient-to-r from-[#4CAD51] to-[#2195ED] text-white p-8 flex flex-col"
      >
        <div className="text-center mb-6">
          <h1 className="text-6xl font-bold tracking-wider">KARTU TANDA ANGGOTA</h1>
          <p className="text-4xl mt-2 opacity-90">Bank Sampah Sido Makmur</p>
      ...
      <div
        id="id-card-back"
        style={{ width: '1016px', height: '638px' }}
        className="bg-gradient-to-r from-[#4CAD51] to-[#2195ED] text-white p-8 flex flex-col items-center justify-center text-center pt-2"
      >
        <h2 className="text-6xl font-bold">Bank Sampah Sido Makmur</h2>
        <p className="text-3xl mt-4 opacity-90">
          Kel Tambangan, Kec. Mijen, Kota Semarang, 50215
        </p>
      </div>
    </div>
  );
